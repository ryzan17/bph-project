    ...
    <header class="header-area">
        ...
        <div id="header" id="home">
            <div class="container">
                ...
                <div id="logo">
                    <a href="index.html"><img src="assets/images/logo/logomenkes.png" alt="logo" title="" style="max-width: 100px;"></img></a>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <p>Di website deteksi dini Benign Prostatic Hyperplasia.</p>
                    <a href="" class="template-btn mt-3">Mulai Pendeteksian</a>
                </div>
            </div>
        </div>
    </section>
